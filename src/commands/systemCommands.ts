  ...
  help: (): CommandResult => ({
    output: [
      ...
      formatSection('Apps', [
        ...
        `${c.cyan}open home${c.reset}             ${c.gray}Homepage${c.reset}`,
        `${c.cyan}open about${c.reset}            ${c.gray}About page${c.reset}`,
        ...
        `${c.cyan}open blog${c.reset}             ${c.gray}SlashDot member articles${c.reset}`,
        ...
        `${c.cyan}open periodic${c.reset}         ${c.gray}Periodic table${c.reset}`,
        `${c.cyan}open fourier${c.reset}          ${c.gray}Fourier visualizer${c.reset}`,
        `${c.cyan}open gravity${c.reset}          ${c.gray}Gravity simulator${c.reset}`,
        `${c.cyan}open dna${c.reset}              ${c.gray}DNA sequence viewer${c.reset}`,
        `${c.cyan}open grapher${c.reset}          ${c.gray}Function plotter${c.reset}`,
        ...
        `${c.cyan}open jsonformat${c.reset}       ${c.gray}JSON formatter & validator${c.reset}`,
        ...
        `${c.cyan}open passgen${c.reset}          ${c.gray}Password generator${c.reset}`,
        `${c.cyan}open diffview${c.reset}         ${c.gray}Diff viewer${c.reset}`,
        `${c.cyan}open coderunner${c.reset}       ${c.gray}Code runner (fake)${c.reset}`,
        `${c.cyan}open lorem${c.reset}            ${c.gray}Lorem ipsum generator${c.reset}`,
        `${c.cyan}open hashgen${c.reset}          ${c.gray}Hash generator${c.reset}`,
        `${c.cyan}open paint${c.reset}            ${c.gray}Paint app${c.reset}`,
        `${c.cyan}open asciiart${c.reset}         ${c.gray}ASCII art generator${c.reset}`,
        `${c.cyan}open pixelart${c.reset}         ${c.gray}16x16 pixel art editor${c.reset}`,
        `${c.cyan}open calendar${c.reset}         ${c.gray}Calendar with events${c.reset}`,
        ...
        `${c.cyan}open currency${c.reset}         ${c.gray}Currency converter${c.reset}`,
        `${c.cyan}open bmi${c.reset}              ${c.gray}BMI calculator${c.reset}`,
        `${c.cyan}open agecalc${c.reset}          ${c.gray}Age calculator${c.reset}`,
        `${c.cyan}open habittracker${c.reset}     ${c.gray}Habit tracker${c.reset}`,
        `${c.cyan}open newsticker${c.reset}       ${c.gray}IISER campus news${c.reset}`,
        `${c.cyan}open leaderboard${c.reset}      ${c.gray}Top terminal users${c.reset}`,
        `${c.cyan}open githubstats${c.reset}      ${c.gray}Live GitHub repo stats${c.reset}`,
        `${c.cyan}open wikipedia${c.reset}        ${c.gray}Wikipedia search${c.reset}`,
        `${c.cyan}open tamagotchi${c.reset}       ${c.gray}Virtual pet${c.reset}`,
        `${c.cyan}open stocks${c.reset}           ${c.gray}IISER fake stock market${c.reset}`,
        `${c.cyan}open horoscope${c.reset}        ${c.gray}IISER horoscope${c.reset}`,
        `${c.cyan}open lovecalc${c.reset}         ${c.gray}Love calculator (always 100%)${c.reset}`,
        `${c.cyan}open magic8${c.reset}           ${c.gray}Magic 8-Ball${c.reset}`,
        `${c.cyan}open deployed${c.reset}         ${c.gray}Is it deployed? (always no)${c.reset}`,
        `${c.cyan}open sortvis${c.reset}          ${c.gray}Sorting visualizer${c.reset}`,
        `${c.cyan}open pathvis${c.reset}          ${c.gray}Pathfinding visualizer${c.reset}`,
        `${c.cyan}open binconv${c.reset}          ${c.gray}Binary/Hex/Decimal converter${c.reset}`,
        `${c.cyan}open truthtable${c.reset}       ${c.gray}Truth table generator${c.reset}`,
        `${c.cyan}open eqsolver${c.reset}         ${c.gray}Equation solver${c.reset}`,
        `${c.cyan}open mandelbrot${c.reset}       ${c.gray}Mandelbrot fractal explorer${c.reset}`,
        `${c.cyan}open cellaut${c.reset}          ${c.gray}Cellular automaton${c.reset}`,
        ...
        `${c.cyan}open bookSearch${c.reset}       ${c.gray}Open Library book search${c.reset}`,
        `${c.cyan}open exchRate${c.reset}         ${c.gray}Live exchange rates${c.reset}`,
        ...
        `${c.cyan}open budget${c.reset}           ${c.gray}Budget tracker${c.reset}`,
        `${c.cyan}open recipe${c.reset}           ${c.gray}IISER recipe book${c.reset}`,
        `${c.cyan}open countdown${c.reset}        ${c.gray}Countdown timer${c.reset}`,
        `${c.cyan}open mealgent${c.reset}         ${c.gray}Random meal generator${c.reset}`,
        `${c.cyan}open studysched${c.reset}       ${c.gray}Study schedule builder${c.reset}`,
        `${c.cyan}open faketwitter${c.reset}      ${c.gray}Fake Twitter feed${c.reset}`,
        `${c.cyan}open fakewhatsapp${c.reset}     ${c.gray}Fake WhatsApp chat${c.reset}`,
        ...
        `${c.cyan}open debate${c.reset}           ${c.gray}Debate arena${c.reset}`,
        `${c.cyan}open linuscall${c.reset}        ${c.gray}Fake call from Linus${c.reset}`,
        `${c.cyan}open cgpasim${c.reset}          ${c.gray}CGPA simulator${c.reset}`,
        `${c.cyan}open ratemycode${c.reset}       ${c.gray}Rate my code (10/10)${c.reset}`,
        `${c.cyan}open rickroll${c.reset}         ${c.gray}Rickroll detector${c.reset}`,
        ...
        `${c.cyan}open fakeload${c.reset}         ${c.gray}Fake loading screen${c.reset}`,
        `${c.cyan}open fortunecook${c.reset}      ${c.gray}IISER fortune cookie${c.reset}`,
        `${c.cyan}open fixbug${c.reset}           ${c.gray}Bug fix advisor${c.reset}`,
